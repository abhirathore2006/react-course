...
## System Requirements
- Install NodeJs
- Install Any Code editor (e.g. Visual Studio Code, Atom, Webstrom) 

## How To Setup

- Clone the Project
- Checkout the desired branch using command 
...
- start application using command 
    ...
    `npm start`
  >Note: it will start on `port 3000` if any other app is running on port 3000 then it will ask for other port and start on next available port
- Happy Coding
